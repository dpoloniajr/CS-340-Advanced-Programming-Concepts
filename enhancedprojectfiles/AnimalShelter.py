 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "        # Set up test configuration if test_mode is True
    "        if test_mode:
    "           aac_user = "test_user"
    "           user_cs340 = "test_password"
    "        else:
    "           aac_user = "actual_user"
    "           user_cs340 = "actual_password"
    "
    "        # Initialize the MongoClient using the test or actual configuration",
